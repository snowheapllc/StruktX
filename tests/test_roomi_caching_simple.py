"""
Simple test for Roomi caching integration.
"""
...
class TestRoomiCachingSimple:
    """Simple test for Roomi caching functionality."""
    ...
    def test_device_cache_data_model(self):
        """Test device cache data model."""
        from datetime import datetime, timezone
        ...
        assert cache_data.device_data["device_id"] == "dev_123"
        assert cache_data.status == "success"
        assert cache_data.message == "Device controlled successfully"
