...
from .intent_cache_types import IntentCacheConfig, HandlerCacheConfig, CacheStrategy, CacheScope, DictData
...
class MemoryConfig(BaseModel):
    ...
    def update_handler_cache_config(self, handler_name: str, config: HandlerCacheConfig) -> None:
...
def create_memory_config_from_dict(config_dict: Dict[str, Any]) -> MemoryConfig:
    ...
    handler_configs = {}
    for handler_name, handler_config_dict in config_dict.get("handler_cache_configs", {}).items():
