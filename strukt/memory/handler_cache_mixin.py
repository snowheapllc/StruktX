...
from .intent_cache_types import HandlerCache, HandlerCacheConfig, CacheStrategy, CacheScope
...
class HandlerCacheMixin(HandlerCache, ABC):
    ...
    def apply_cached_data(self, state: InvocationState, cached_data: Dict[str, Any]) -> HandlerResult:
